...
// extract from https://github.com/pauloo27/tuner/blob/11dd4c37862c1c26521a01c8345c22c29ab12749/search/youtube.go#L27
func ytSearch(searchTerm string, limit int) (results []*SearchResult, err error) {
	...
	if err != nil {
		return nil, errors.New("error ocurred while getting youtube page")
	}
	...
	if err != nil {
		return nil, fmt.Errorf("cannot get the song for: %s", searchTerm)
	}
